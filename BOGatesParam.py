...
A_prim_envelope = [None] * n
B_prim_envelope = [None] * n

G_prim_envelope = [None] * n
P_prim_envelope = [None] * n
H_prim_envelope = [None] * n
...
G_left_dot_FR = [None] * n
G_left_prev_dot_FR = [None] * n
P_left_dot_FR = [None] * n
P_left_prev_dot_FR = [None] * n

G_right_dot_FR = [None] * n
G_right_prev_dot_FR = [None] * n
P_right_dot_FR = [None] * n
P_right_prev_dot_FR = [None] * n

#output
G_and_prev_left_dot_FR = [None] * n
G_and_prev_right_dot_FR = [None] * n
P_and_prev_left_dot_FR = [None] * n
P_and_prev_right_dot_FR = [None] * n
...
G_left_dot_SR = [None] * n
G_left_prev_dot_SR = [None] * n
P_left_dot_SR = [None] * n
P_left_prev_dot_SR = [None] * n

G_right_dot_SR = [None] * n
G_right_prev_dot_SR = [None] * n
P_right_dot_SR = [None] * n
P_right_prev_dot_SR = [None] * n

#output from second row
G_and_prev_left_dot_SR = [None] * n
G_and_prev_right_dot_SR = [None] * n
P_and_prev_left_dot_SR = [None] * n
P_and_prev_right_dot_SR = [None] * n
...
# data from second row
G_left_dot_TR = [None] * n
G_left_prev_dot_TR = [None] * n
P_left_dot_TR = [None] * n
P_left_prev_dot_TR = [None] * n

G_right_dot_TR = [None] * n
G_right_prev_dot_TR = [None] * n
P_right_dot_TR = [None] * n
P_right_prev_dot_TR = [None] * n

#output from second row
G_and_prev_left_dot_TR = [None] * n
G_and_prev_right_dot_TR = [None] * n
P_and_prev_left_dot_TR = [None] * n
P_and_prev_right_dot_TR = [None] * n
